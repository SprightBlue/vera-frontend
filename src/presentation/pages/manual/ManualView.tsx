...
const manualSections = [
  {
    ...
    gridClass: "md:col-span-2", // Tarjeta ancha
  ...
  },
  {
    ...
    icon: Users,
    gridClass: "md:col-span-1", // Tarjeta cuadrada
...
function ManualView() {
  ...
  // Estado para manejar qué tarjeta está abierta en el Modal
  ...
  return (
    <div className="flex min-h-screen bg-[#050816]">
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden ml-[260px] relative">
        <Header 
        ...
        <div className="flex-1 flex flex-col items-center p-8">
          <div className="w-full max-w-5xl flex flex-col">
            ...
            {/* NUEVO: BOTÓN DE REINICIAR TOUR */}
            <div className="flex justify-end mb-6">
                <button 
                    onClick={() => {
                        localStorage.setItem("force_dashboard_tour", "true");
                        navigate("/dashboard"); 
                    }}
        ...
        {selectedSection && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-[#0d1222] border border-[#182033] w-full max-w-2xl rounded-3xl p-8 shadow-2xl shadow-black animate-in fade-in zoom-in-95 duration-200">
              ...
              <div className="w-full h-48 md:h-64 border-2 border-dashed border-[#182033] bg-[#050816]/50 rounded-2xl mb-8 flex flex-col items-center justify-center text-slate-500 group">
                <ImageIcon className="w-12 h-12 mb-2 opacity-50 group-hover:opacity-100 transition-opacity" />
                <p className="text-sm font-medium opacity-50 group-hover:opacity-100 transition-opacity">Espacio para imagen / captura de pantalla</p>
              </div>
