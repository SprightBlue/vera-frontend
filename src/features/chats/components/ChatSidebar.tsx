...
export function ChatSidebar({
    ...
    return (
        <aside
            className="w-full bg-[#0B0D17] border-r border-white/5 flex flex-col h-full shrink-0 select-none overflow-hidden relative shadow-2xl"
            style={{ fontFamily: "'Inter', system-ui, sans-serif" }}
        >
            {/* Efecto de Glow de fondo en sintonía con el sidebar principal */}
            <div
            ...
            <div
                ...
                {/* Título de sección ajustado sin mayúsculas forzadas y con la fuente correcta */}
                <div
                    className="px-3 mt-3 mb-2.5 flex items-center gap-2 text-[clamp(11px,0.65vw,12px)] text-gray-400 font-medium normal-case tracking-wide">
                    <History size={13} className="text-gray-500 stroke-[2]" />
                ...
                <div className="flex-1 flex flex-col min-h-0 relative">
                    {isLoading ? (
                        ...
                        <div className="flex-1 flex items-center justify-center">
                            {/* Texto del EmptyScreen sanitizado a minúsculas */}
