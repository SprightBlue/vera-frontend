            ...
            <div
                ...
                <main
                    ...
                    <div
                        ...
                        <div
                            className="relative flex flex-col md:flex-row md:items-end justify-between gap-5 w-full pb-6">
                            <div
                            ...
                            <div className="flex flex-wrap items-center gap-[clamp(1rem,1.5vw,2rem)]">
                                <FilterToggleGroup title="Estado De Alerta" options={STATUS_FILTER_OPTIONS}
                                                   activeValue={activeStatus} onToggle={handleStatusToggle}/>
                                <FilterToggleGroup title="Nivel de Riesgo" options={RISK_FILTER_OPTIONS}
                                                   activeValue={activeRisk} onToggle={handleRiskToggle}/>
                            </div>
                        </div>
                        ...
                        {loading ? (
                            ...
                            <div
                                className={`w-full flex-1 flex flex-col transition-opacity duration-200 ${isBackgroundLoading ? 'opacity-40 pointer-events-none' : ''}`}>
                                {hasData ? (
                                    <div
                                        className="grid grid-cols-1 xl:grid-cols-2 3xl:grid-cols-3 gap-4 auto-rows-max">
                                        {alerts.map((alert) => {
                                            ...
                                            return (
                                                <ItemCard
                                                    ...
                                                    badges={[
                                                        {
                                                            label: `Riesgo ${RISK_LABELS_ES[level]}`,
                                                            variant: riskVariant
                                                        },
                                                        {
