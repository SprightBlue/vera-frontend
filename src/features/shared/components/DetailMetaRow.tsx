        ...
        ring-1 ring-inset ring-[#161f35]/20 shadow-xl select-none w-full relative overflow-hidden">
            ...
            <div className="flex items-center gap-2 min-w-0 relative z-10">
                ...
                <span className="truncate tracking-wide">
                    ORIGEN: <strong
                    className="text-slate-200 font-sans font-bold select-text tracking-wider">{source || 'NO ESPECIFICADO'}</strong>
                </span>
            </div>
            ...
            <div className="flex items-center gap-2 min-w-0 relative z-10">
                ...
                <span className="truncate tracking-wide">
                    REGISTRO: <strong
                    className="text-slate-200 font-display font-bold select-text tracking-wider">{createdAt}</strong>
                </span>
            </div>
            ...
            <div className="flex items-center gap-2 min-w-0 relative z-10">
                ...
                <span className="truncate tracking-wide">
                    CATEGORÍA: <strong
                    className="text-slate-200 font-sans font-bold select-text tracking-wider">{riskType || 'GENERAL'}</strong>
                </span>
            </div>
        </div>
    );
