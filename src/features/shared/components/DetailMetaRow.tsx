    ...
    return (
        ...
        ring-1 ring-inset ring-white/5 shadow-xl select-none w-full relative overflow-hidden">
            ...
            <div className="flex items-center gap-2 min-w-0 relative z-10">
                ...
                <span>
                    Origen: <strong className="text-slate-200 font-sans font-semibold select-text normal-case">
            ...
            <div className="flex items-center gap-2 min-w-0 relative z-10">
                ...
                <span>
                    Registro: <strong className="text-slate-200 font-sans font-semibold select-text normal-case">
                        {createdAt}
                    </strong>
                </span>
            </div>
            ...
            <div className="flex items-center gap-2 min-w-0 relative z-10">
                ...
                <span>
                    Categoría: <strong className="text-slate-200 font-sans font-semibold select-text normal-case">
                        {riskType || 'General'}
                    </strong>
                </span>
            </div>
