    ...
    return (
        <div className="flex items-center">
            <button
                ...
                hover:from-[#101735] hover:to-[#0a0f24] border border-[#182033]/80 rounded-lg text-[10px] font-black
                text-[#94a3b8] hover:text-white tracking-widest uppercase shadow-lg shadow-black/20 ring-1
