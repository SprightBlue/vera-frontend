        ...
        >
            ...
            <div className="flex flex-col justify-between min-w-0 flex-1 relative z-10 gap-2.5">
                <div className="flex flex-col gap-1 w-full">
                    {subtitle && (
                        <span className="text-[clamp(0.75rem,0.8vw,0.86rem)] font-sans font-bold text-slate-400 leading-relaxed tracking-wider select-text uppercase">
                            {subtitle}
                        </span>
                    )}
                    <h3 className="text-[clamp(0.9rem,1vw,1.15rem)] font-display font-black text-white line-clamp-2 select-text group-hover:text-slate-100 transition-colors uppercase w-full">
                        {title}
                    </h3>
                </div>
