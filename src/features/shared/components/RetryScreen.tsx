    ...
    return (
        <div className="w-full flex-1 flex items-center justify-center py-[clamp(3rem,6vw,9rem)] select-none animate-fade-in mx-auto max-w-7xl">
            <button
                ...
                border border-[#182033]/80 rounded-lg text-[clamp(10px,0.6vw,12px)] font-black text-slate-400 hover:text-slate-200
                tracking-widest uppercase shadow-lg shadow-black/20 ring-1 ring-inset ring-[#161f35]/30
