...
export function DetailHeader({
    ...
    return (
        ...
        ring-1 ring-inset ring-[#161f35]/20 w-full`}>
            ...
            <div
                ...
                <div className="space-y-2.5 min-w-0 flex-1 w-full">
                    <div className="flex flex-wrap items-center gap-3 w-full">
                        ...
                        <span
                            className={`px-2.5 h-5 flex items-center rounded-md text-[clamp(10px,0.55vw,11px)] font-sans font-bold tracking-wider uppercase border shrink-0 shadow-xs ${config.bgColor} ${config.borderColor} ${config.textColor}`}>
            ...
            <div
                className="w-full h-1.5 bg-slate-950/60 rounded-full mt-6 overflow-hidden ring-1 ring-white/5 relative">
                <div
