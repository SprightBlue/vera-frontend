                ...
                {options.map((option) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className={`absolute -top-5 -right-5 w-12 h-12 rounded-full filter blur-md pointer-events-none transform origin-top-right transition-all duration-300 ease-out z-0 ${
                                isActive
