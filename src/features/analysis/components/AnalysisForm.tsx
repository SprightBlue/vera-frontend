...
export function AnalysisForm({
    ...
    return (
        <div className="w-full flex flex-col gap-2 font-sans select-none">
            <span
                className="text-[clamp(10px,0.55vw,11px)] font-sans font-bold tracking-wider text-slate-500 uppercase">
                FORMULARIO DE ANÁLISIS DE INTELIGENCIA ARTIFICIAL
            </span>

            <div
                className="w-full flex flex-col rounded-xl border border-[#161f37] bg-linear-to-b from-[#080d20] to-[#040714] p-[clamp(1.2rem,1.8vw,2rem)] ring-1 ring-inset ring-[#161f35]/20 shadow-2xl transition-all duration-300 relative overflow-hidden group">
                ...
                <div
                    className="absolute top-0 right-0 w-[clamp(220px,22vw,400px)] h-[clamp(220px,22vw,400px)] rounded-full bg-blue-500/3 filter blur-[90px] pointer-events-none"/>
                ...
                <div className="relative z-10 flex flex-col w-full">
                    ...
                    <div
                        className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-t border-[#161f37]/60 pt-[clamp(1rem,1.5vw,1.8rem)] mt-2">
                        ...
                        <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
                            ...
                            {file && (
                                <div
                                    className={`inline-flex items-center gap-2.5 bg-[#050814]/90 border border-[#161f37] pl-3 pr-1.5 h-9 rounded-lg max-w-xs animate-fade-in transition-all duration-200 ${
                                        loading ? 'opacity-40 pointer-events-none' : ''
                                    }`}>
                                    <File size={12} className="text-blue-400 shrink-0 stroke-[2.2]"/>
                                    <span
                                        className="text-[clamp(11px,0.65vw,13px)] font-sans font-bold tracking-wide text-slate-300 truncate select-text">
                                        {file.name}
                                    </span>
                                    <button
                                        type="button"
