    ...
    return (
        <div
            ...
            <div
                ...
                <main
                    className="flex-1 overflow-y-auto no-scrollbar px-[clamp(1rem,2vw,3rem)] py-[clamp(1.2rem,2vw,2.5rem)] flex flex-col justify-between">
                    <div
                        className="mx-auto max-w-5xl w-full flex-1 flex flex-col gap-[clamp(1.5rem,2.5vw,3rem)] animate-fade-in">

                        <div className="w-full relative pb-[clamp(1rem,1.5vw,1.8rem)] overflow-hidden select-none">
                            {/* Reemplazado h2 por p con la clase body-text global de Vera */}
                            <p className="body-text mt-1.5 select-text">
                                El contenido que ingreses será analizado por un modelo de inteligencia artificial para
                                determinar su nivel de riesgo y generar un resumen del mismo. Puedes ingresar texto
                                directamente o subir un archivo de texto para su análisis.
                            </p>
