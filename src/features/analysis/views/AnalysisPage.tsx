            ...
            <div className="flex flex-1 flex-col min-w-0">
                ...
                <main className="flex-1 overflow-y-auto px-4 py-8 sm:px-6 lg:px-8">
                    <div className="mx-auto max-w-5xl w-full">
                        ...
                        <div className="mb-8">
                            <AnalysisForm loading={isLoading} onAnalyze={executeAnalysis}/>
                        </div>
                        ...
                        {isLoading && (
                            <div className="analysis-appear w-full animate-pulse space-y-6 mb-8">
                                <div className="grid gap-6 lg:grid-cols-12 items-stretch">
                                    <div
                                        className="lg:col-span-4 rounded-xl border border-slate-900 bg-slate-900/20 p-6 flex flex-col items-center justify-center min-h-55">
                                        <div className="h-3 w-24 bg-slate-800 rounded self-start mb-6"/>
                                        <div
                                            className="h-28 w-28 rounded-full border-8 border-slate-800 flex items-center justify-center"/>
                                    </div>
                                    <div className="flex flex-col gap-4 lg:col-span-8 justify-between">
                                        <div
                                            className="flex-1 rounded-xl border border-slate-900 bg-slate-900/20 p-5 space-y-3 min-h-25">
