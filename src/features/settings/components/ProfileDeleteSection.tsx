            ...
            <div className="p-[clamp(1.2rem,2vw,2rem)] flex flex-col gap-6 relative z-10">
                ...
                <div
                    ...
                    <div className="w-full text-center sm:text-left">
                        ...
                        <h3 className="heading-md normal-case text-red-200 mb-2.5">
                            Eliminar cuenta
                        </h3>
                        <p className="body-text text-red-300/70">
                    ...
                    <div className="border-t border-red-500/20 pt-6 animate-fadeIn flex flex-col gap-5">
                        <div className="flex items-center gap-3 bg-red-950/40 border border-red-500/20 p-4 rounded-lg">
                            <div className="flex flex-col gap-0.5">
                                <h4 className="text-xs font-semibold text-red-200 normal-case tracking-wide leading-none">
                                    Se requiere confirmación de identidad
                                </h4>
                                <p className="text-[12px] text-red-300/80 font-medium leading-relaxed mt-1" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
                        ...
                        <div className="flex flex-col md:flex-row gap-4 items-center w-full">
                            ...
                            <div className="flex flex-col gap-2 w-full md:flex-1" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
                                <div className="relative flex items-center w-full">
                                    ...
                                    <input
                                        ...
                                        disabled={isDeleting}
                                        className={`h-11 w-full bg-[#03050c]/90 text-red-100 rounded-lg pl-11 pr-11 text-[13.5px] font-semibold outline-hidden transition-all shadow-inner border 
                                            ${error
                                ...
                                {error ? (
                                    <span
                                        className="text-[11.5px] text-red-500 font-semibold leading-none pl-1 flex items-center gap-1.5 animate-fadeIn">
                                        <AlertCircle className="w-3.5 h-3.5 shrink-0" />
                                        {error}
                                    </span>
                                ) : (
                                    <span
                                        className="text-[11.5px] text-red-400/50 font-medium leading-none pl-1">
